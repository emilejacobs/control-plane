...
| 05 | [LaunchAgent dual-context Status fallback](./issues/05-launchagent-dual-context.md) ✅ done 2026-05-25 (commits `d20ff13`..`d566f84`; bench-Mac roll pending — agent binary needs cross-compile + hot-swap) | AFK | 4–6 hr | slice 1 (surfaced live during slice 3 bench-Mac use) |
